<template>
	<el-dialog v-model="state.dialogVisible" top="2vh" width="50%" center>
		...
		<div style="height: 600px; overflow-y: auto">
			<table id="printArea3" style="width: 100%">
				<tr>
		...
		<template #footer>
			<span class="dialog-footer">
				<el-button v-print="'#printArea3'" type="primary">打印</el-button>
...
const show = () => {
	...
	let questions = kousuan3yService.genQuestion(kousuan3yService.readConfig())
